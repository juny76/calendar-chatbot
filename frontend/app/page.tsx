    ...
    <div>
      ...
      <main>
        <div className="text-center mt-64">
          <h1 className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Schedule Assistant</h1>
          <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Your own personal AI assistant for managing your Schedule.</p>
        </div>
      </main>
    </div>
  );
